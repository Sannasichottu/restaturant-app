  ...
  return (
    <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id="home">
      ...
      <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi est laborum laboriosam eaque sequi hic praesentium in sapiente, nobis provident sint aperiam harum saepe sed minus delectus vero eum corporis!
      </p>
