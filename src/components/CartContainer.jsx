...
const CartContainer = () => {
    ...
    const [flag, setFlag] = useStateValue();
    ...
    const clearCart = () => {
        ...
        localStorage.setIten("cartItems", JSON.stringify([]));
    };
  ...
  return (
    ...
    exit={{opacity : 0, x:200}} className="fixed top-0 right-0  w-full md:w-375 h-screen bg-white drop-shadow-md flex flex-col z-[101]">
